...
Please, refer to the example repo [Functional-UI5-Example](https://github.com/LuccasJSantos/Functional-UI5-Example) where you can see a Todo webapp with this lib implementation.
